...
--
-- Host: localhost:3306
-- Generation Time: Dec 22, 2016 at 04:16 PM
...
INSERT INTO `divisao` (`idDivisao`, `descricao`) VALUES
(10, 'calor');
...
--
ALTER TABLE `alarme`
  MODIFY `idAlarme` int(30) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ar_condicionado`
--
ALTER TABLE `ar_condicionado`
  MODIFY `idArCondicionado` int(30) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `audio`
--
ALTER TABLE `audio`
  MODIFY `idAudio` int(30) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `estore`
--
ALTER TABLE `estore`
  MODIFY `idEstore` int(30) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `iluminacao`
--
ALTER TABLE `iluminacao`
  MODIFY `idIluminacao` int(30) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `porta`
--
ALTER TABLE `porta`
  MODIFY `idPorta` int(30) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tv`
--
ALTER TABLE `tv`
  MODIFY `idTv` int(30) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `alarme`
  ...
  ADD CONSTRAINT `alarme_ibfk_3` FOREIGN KEY (`divisao`) REFERENCES `divisao` (`idDivisao`) ON DELETE CASCADE ON UPDATE CASCADE;
