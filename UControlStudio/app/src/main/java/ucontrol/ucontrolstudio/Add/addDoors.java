...
public class addDoors extends AppCompatActivity implements SensorEventListener {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            // Result handling
                            Toast.makeText(addDoors.this, "New door added", Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    // Error handling
                    Toast.makeText(addDoors.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
                    ...
                    (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try {
                                ...
                                ArrayAdapter adapterDivisoes = new ArrayAdapter(addDoors.this, android.R.layout.simple_list_item_1, divisoes);
                                ...
                                spinner = (Spinner)findViewById(R.id.spinnerDivisionsDoors);
